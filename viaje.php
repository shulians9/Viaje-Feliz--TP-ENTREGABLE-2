...
class viaje {
    ...
    private $codigoViaje ;
    private $destino;
    private $canMaximaPasajeros;
    private $pasajerosDelViaje;
    private $responsable;

    //se define metodo constructor
    public function __construc ($codigoViaje, $destino, $canMaximaPasajeros, $pasajerosDelViaje,$responsableViaje){
    ...
    public function getResponsableViaje (){
        return $this->responsableViaje = $responsableViaje;
    }
    public function setResponsableViaje (){
        $this->responsableViaje = $responsableViaje;
    }
